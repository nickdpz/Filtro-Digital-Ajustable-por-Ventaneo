...
# Date: Fri, 05 Oct 2018 17:26:11 GMT
#set_units -time ns
...
create_generated_clock -name {ADC_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 585 1169} -nominal_period 7817.9384203480586 [list [get_pins {ClockBlock/aclk_glb_0}]]
