...
# Date: Wed, 03 Oct 2018 23:42:29 GMT
#set_units -time ns
...
create_generated_clock -name {ADC_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 31 61} [list [get_pins {ClockBlock/aclk_glb_0}]]
