...
/* IRS_T */
#define IRS_T__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define IRS_T__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define IRS_T__INTC_MASK 0x01u
#define IRS_T__INTC_NUMBER 0u
#define IRS_T__INTC_PRIOR_NUM 7u
#define IRS_T__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define IRS_T__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define IRS_T__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
#define ISR_Data__INTC_MASK 0x02u
#define ISR_Data__INTC_NUMBER 1u
#define ISR_Data__INTC_PRIOR_NUM 7u
#define ISR_Data__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define ISR_Data__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ISR_Data__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Pin_2ADC */
#define Pin_2ADC__0__INTTYPE CYREG_PICU2_INTTYPE5
#define Pin_2ADC__0__MASK 0x20u
#define Pin_2ADC__0__PC CYREG_PRT2_PC5
#define Pin_2ADC__0__PORT 2u
#define Pin_2ADC__0__SHIFT 5u
#define Pin_2ADC__AG CYREG_PRT2_AG
#define Pin_2ADC__AMUX CYREG_PRT2_AMUX
#define Pin_2ADC__BIE CYREG_PRT2_BIE
#define Pin_2ADC__BIT_MASK CYREG_PRT2_BIT_MASK
#define Pin_2ADC__BYP CYREG_PRT2_BYP
#define Pin_2ADC__CTL CYREG_PRT2_CTL
#define Pin_2ADC__DM0 CYREG_PRT2_DM0
#define Pin_2ADC__DM1 CYREG_PRT2_DM1
#define Pin_2ADC__DM2 CYREG_PRT2_DM2
#define Pin_2ADC__DR CYREG_PRT2_DR
#define Pin_2ADC__INP_DIS CYREG_PRT2_INP_DIS
#define Pin_2ADC__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Pin_2ADC__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Pin_2ADC__LCD_EN CYREG_PRT2_LCD_EN
#define Pin_2ADC__MASK 0x20u
#define Pin_2ADC__PORT 2u
#define Pin_2ADC__PRT CYREG_PRT2_PRT
#define Pin_2ADC__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Pin_2ADC__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Pin_2ADC__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Pin_2ADC__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Pin_2ADC__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Pin_2ADC__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Pin_2ADC__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Pin_2ADC__PS CYREG_PRT2_PS
#define Pin_2ADC__SHIFT 5u
#define Pin_2ADC__SLW CYREG_PRT2_SLW
